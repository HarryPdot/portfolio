    ...
    return (
        <div className='project-box-detail-container'>
            ...
            <div className='project-box-details-grid animate__animated animate__fadeIn'>
                <div className='project-box-detail-title'>02. <span>Project Title</span></div>
                <div className='project-box-detail-description'> My best days are when I am working with a computer in front of me. I have a love of learning and learn new programs very quickly.My best days are when I am working with a computer in front of me. I have a love of learning and learn new programs very quickly.</div>
